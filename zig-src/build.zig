...
pub fn build(b: *std.Build) error{ OutOfMemory, NoSpaceLeft }!void {
    ...
    if (target.result.os.tag == .windows) {
        ...
        exe.addIncludePath(.{
            .path = "/media/mark/data/home/mark/SDKs/sdk-macos-13.3/root/usr/include"
        });
        exe.addLibraryPath(.{
            .path = "/media/mark/data/home/mark/SDKs/sdk-macos-13.3/root/usr/lib"
        });
        exe.addFrameworkPath(.{
            .path = "/media/mark/data/home/mark/SDKs/sdk-macos-13.3/root/System/Library/Frameworks"
        });
